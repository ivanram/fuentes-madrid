...
El listado cambia poco a poco. Para refrescarlo: descarga el CSV más reciente desde
[datos.madrid.es](https://datos.madrid.es/dataset/300051-0-fuentes) (recurso CSV del año en curso)
y vuelve a generar `fuentes.json`. Si me lo pides, te regenero el archivo en un momento.
...
| `icon-192.png` / `icon-512.png` | Icono de la app (oso bebiendo de una fuente) |
